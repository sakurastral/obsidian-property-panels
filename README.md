...
Version 0.9.2 requires Obsidian 1.8.0 or newer.
...
Panel layouts support **Top**, **Left**, **Left, align end**, and **Inline** label positions. **Left, align end** uses the same label/control columns as **Left**, but aligns every label to the end of the label column. On narrow screens it returns to the standard stacked, start-aligned layout.
